...
DRUG_STEP1_PROMPT_TEMPLATE = os.path.join(
    CUR_DIR, "prompt_templates", "drug_analyze.txt"
)
DRUG_STEP2_PROMPT_TEMPLATE = os.path.join(
    CUR_DIR, "prompt_templates", "drug_solution.txt"
)
...
drug_step1_chain = create_chain(
    llm=llm,
    template_path=DRUG_STEP1_PROMPT_TEMPLATE,
    output_key="drug-analysis",
)
drug_step2_chain = create_chain(
    llm=llm,
    template_path=DRUG_STEP2_PROMPT_TEMPLATE,
    output_key="output",
)
